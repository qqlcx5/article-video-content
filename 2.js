...
(function () {
  ...
  function exportToJSON() {
    ...
    GM_download({
      ...
      onload: function () {
        showNotification(
          `已导出 ${videoLinks.length} 个视频到JSON文件`,
          "success",
        );
  ...
  function exportToCSV() {
    ...
    GM_download({
      ...
      onload: function () {
        showNotification(
          `已导出 ${videoLinks.length} 个视频到CSV文件`,
          "success",
        );
        URL.revokeObjectURL(url);
      },
  ...
  function createFloatingButtonGroup() {
    ...
    // 创建各种导出按钮
    const normalButton = createMenuButton(
    ...
    const sortButton = createMenuButton(
      '<i class="fas fa-sort-amount-down"></i> 按点赞数复制',
      () => {
    ...
    const copyJsonButton = createMenuButton(
      '<i class="fas fa-clipboard"></i> 复制JSON',
      () => {
        copyAsJSON();
        hideExportMenu();
      },
    ...
    const jsonButton = createMenuButton(
    ...
    const csvButton = createMenuButton(
