...
export function generateRequestScript(
  videos: Pick<ILocalVideo, "id" | "href" | "title">[],
  options: RequestScriptOptions = {}
): string {
  const endpoint =
    options.endpoint ?? "https://get-notes.luojilab.com/voicenotes/web/topics/notes/stream";
